...
$vo_parc = new ParceiroVO();
$ctrl_parc = new ParceiroCTRL();

if (isset($_POST['btnSalvar'])) {

    $vo_parc->setNomeParceiro($_POST['nome']);
    $vo_parc->setTelefoneParceiro($_POST['telefone']);
    $vo->setEmailUsuario($_POST['email']);

    $ret = $ctrl_user->AlterarDadosPessoaParceiro($vo_parc, $vo);
}
            ...
            <div id="page-inner">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <form method="post" action="dados_parceiro.php" enctype="multipart/form-data">
                        ...
                        <form method="post" action="dados_parceiro.php">

                            <div class="form-group" id="divNome">

                                <label>Nome completo</label>

                                <input type="text" class="form-control" placeholder="Digite aqui..." name="nome" id="nome" value="<?= $dadosParc[0]['nome_parceiro'] ?>" />
                            ...
                            <div class="form-group" id="divEmail">
                                ...
                                <input type="email" class="form-control" placeholder="Digite aqui..." name="email" id="email" value="<?= $dadosParc[0]['email_usuario'] ?>" onchange="ValidarEmail(1)" />
                            ...
                            <div class="form-group" id="divTelefone">
                                ...
                                <input class="form-control tel" placeholder="Digite aqui..." name="telefone" id="telefone" value="<?= $dadosParc[0]['telefone_parceiro'] ?>" />
                        ...
                        <form action="dados_parceiro.php" method="post">
