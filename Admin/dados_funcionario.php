...
if (isset($_POST['btnSalvar'])) {
    ...
    $ret = $ctrl_user->AtualizarDadosFuncionario($vo, $vo_fun);
}
                ...
                <div id="page-inner">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <form method="post" action="dados_funcionario.php" enctype="multipart/form-data">
                            ...
                            <form method="post" action="dados_funcionario.php">
                                ...
                                <input type="hidden" name="code">
                                    ...
                                    <div class="form-group" id="divNome">
                                        ...
                                        <input class="form-control" placeholder="Digite aqui..." name="nome" id="nome" value="<?= $dadosFunc[0]['nome_funcionario'] ?>"/>
                                    ...
                                    <div class="form-group" id="divEmail">
                                        ...
                                        <input class="form-control" placeholder="Digite aqui..." name="email" id="email" value="<?= $dadosFunc[0]['email_usuario'] ?>" onchange="ValidarEmail(1)" />
                                    ...
                                    <div class="form-group" id="divTelefone">
                                        ...
                                        <input class="form-control tel" maxlength="11" placeholder="Digite aqui..." name="telefone" id="telefone" value="<?= $dadosFunc[0]['telefone_funcionario'] ?>"/>
                                    ...
                                    <button class="btn btn-success" name="btnSalvar" onclick="return Validar(7)">Salvar</button>
